 ...
 */
/*********************************************************************/ /**
                                                                         * @brief 		Initial System Tick with using
...
/*********************************************************************/ /**
                                                                         ...
                                                                         *counter
                                                                         * @param[in]	NewState	System Tick counter
                                                                         *status, should be:
                                                                         * 					- ENABLE
                                                                         * 					- DISABLE
                                                                         * @return 		None
...
/*********************************************************************/ /**
                                                                         * @brief 		Get current value of System Tick
                                                                         *counter
                                                                         * @param[in]	None
                                                                         * @return 		current value of System Tick
                                                                         *counter
                                                                         **********************************************************************/
